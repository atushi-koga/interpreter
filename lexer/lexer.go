...
// @todo: byte型とは？
// uint8に対するシノニム。01001011 のような符号なし8bitで値を保存する。01001011 は10進数で75でasciiコードで""。stringに変換すると、"K"になる
// rune型はint32に対するシノニム。慣習的に値がUnicodeのコードポイントであることを示す。
// シングルクォートで囲むと、UTF-8でエンコードしたbyte値が得られる。
